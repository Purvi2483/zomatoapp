...
const url="https://augintern.herokuapp.com/menuItem";
const postData="https://augintern.herokuapp.com/placeOrder";
                ...
                <div className="panel panel-info">
                    ...
                    <div className="panel-body">
                        ...
                        <div className="row">
                            ...
                            <button className="btn btn-primary" onClick={this.checkout} type="submit">Submit</button>
                            </div>
                            </form>
                        </div>
                    </div>                        
